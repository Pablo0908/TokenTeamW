...
const en = {
  ...
  profile: {
    ...
    language: 'Language',
    editProfile: 'Edit profile', editProfileHint: 'Your name and last name',
    saveProfile: 'Save', saveSuccess: 'Profile updated.', cancelEdit: 'Cancel',
    changeEmail: 'Change email', changeEmailHint: 'Update your email address',
    changeEmailStep: 'Enter the new email address. A verification code will be sent to your current email.',
    changeEmailSendCode: 'Send code', changeEmailSending: 'Sending…',
    changeEmailCodeSent: 'Code sent to your current email. Enter it below.',
    changeEmailSubmit: 'Update email', changeEmailSubmitting: 'Updating…',
...
const es = {
  ...
  profile: {
    ...
    language: 'Idioma',
    editProfile: 'Editar perfil', editProfileHint: 'Tu nombre y apellido',
    saveProfile: 'Guardar', saveSuccess: 'Perfil actualizado.', cancelEdit: 'Cancelar',
    changeEmail: 'Cambiar correo', changeEmailHint: 'Actualiza tu dirección de correo',
    changeEmailStep: 'Ingresa el nuevo correo. Se enviará un código de verificación a tu correo actual.',
    changeEmailSendCode: 'Enviar código', changeEmailSending: 'Enviando…',
    changeEmailCodeSent: 'Código enviado a tu correo actual. Ingrésalo a continuación.',
    changeEmailSubmit: 'Actualizar correo', changeEmailSubmitting: 'Actualizando…',
    changeEmailSuccess: 'Correo actualizado correctamente.',
