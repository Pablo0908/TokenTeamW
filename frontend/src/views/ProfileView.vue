...
<template>
  <div class="space-y-6 px-4 pb-4 pt-6">
    ...
    <section class="space-y-2">
      <h2 class="font-semibold">{{ $t('profile.profileSettings') }}</h2>
      <div class="surface overflow-hidden">
        <RouterLink to="/profile/security" class="flex w-full items-center gap-4 p-4 tap-target transition-colors">
