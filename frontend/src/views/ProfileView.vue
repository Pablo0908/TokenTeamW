...
<template>
  <div class="space-y-6 px-4 pb-4 pt-6">
    ...
    <section class="space-y-2">
      ...
      >
        <span class="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-gradient-to-br from-primary to-secondary text-sm font-bold text-primary-content">
          {{ initials }}
        </span>
    ...
    <section class="space-y-2">
      ...
      <!-- Accessibility (simplified — motor & interaction removed) -->
